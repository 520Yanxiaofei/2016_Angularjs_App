angular.module("App.Commonweal.Competition", []).controller("App.Commonweal.Competition.Controller", [
    "$scope",
    "$state",
    "$ionicScrollDelegate",
    "Overview",
    ...
    function(
        ...
        function rankloading() {
            ...
            $scope.touBtns = function() {
                ...
                //公益投票
            $scope.touGong = function() {
                $state.go("commonweal.contribution", {
                    id: $state.params.id,
                    ids: $state.params.ids //活动标识
                });
                $scope.modal.hide();
            }
