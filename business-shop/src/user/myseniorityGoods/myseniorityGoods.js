angular.module("App.User.MyseniorityGoods", []).controller("App.User.MyseniorityGoods.Controller", [
    "$scope",
    "$state",
    "$ionicHistory",
    "Loading",
    ...
    function(
        ...
        $scope.loadMore = function() {
            ...
            //获取列表数据
            Member.getMyseniorityGoods(params).$promise.then(function(goods_list) {
                Loading.hide();
